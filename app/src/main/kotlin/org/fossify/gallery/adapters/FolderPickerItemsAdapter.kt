...
// The rows of FolderPickerDialog: commons' FilepickerItemsAdapter, with one difference. A
// folder listed from pCloud comes without a count of what is inside it, and such a folder
// (children below 0) shows no count rather than a wrong one
class FolderPickerItemsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = createViewHolder(org.fossify.commons.R.layout.item_filepicker_list, parent)
